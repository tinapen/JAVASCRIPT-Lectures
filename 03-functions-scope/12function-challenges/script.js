...
// ***** TINAPEN'S ANSWER *****
// Challenge 1
const gCelsius = (fahrenheit) => {
  return (fahrenheit - 32) * (5 / 9);
};
console.log(`The temperature is ${gCelsius(32)} \xB0C`);
...
((length, width) => {
  ...
  const output = `This area of a rectangle with a length of ${length} and a width of ${width} is ${area}`;
